...
def generate_launch_description():
    ...
    race_pkg_dir = get_package_share_directory('race_path_follower')
    race_launch_dir = os.path.join(race_pkg_dir, 'launch')
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(race_launch_dir, 'navigation_launch.py')
                ),
                launch_arguments={
                    'namespace': namespace,
                    'use_sim_time': use_sim_time,
